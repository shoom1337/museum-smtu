...
<div class="page-hero">
  <div class="container">
    <h1><?php echo museum_opt('page_visit_rules_h1', 'Правила посещения'); ?></h1>
    <p><?php echo museum_opt('page_visit_rules_sub', 'Условия посещения, режим работы и форма предварительной записи'); ?></p>
  </div>
</div>
