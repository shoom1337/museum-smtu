...
<div class="page-hero">
  <div class="container">
    <h1><?php echo museum_opt('page_graduates_h1', 'Выдающиеся выпускники'); ?></h1>
    <p><?php echo museum_opt('page_graduates_sub', 'База данных известных выпускников СПбГМТУ — инженеры, учёные, адмиралы, конструкторы'); ?></p>
  </div>
</div>
