  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7 hero-content">
        <div class="hero-badge"><?php echo museum_opt('hero_badge', 'Основан в 1941 году'); ?></div>
        <h1>Музей истории<br><span>кораблестроения</span><br>и мореплавания</h1>
        <p><?php echo nl2br(esc_html(museum_opt_raw('hero_description', 'Уникальная коллекция, раскрывающая историю Санкт-Петербургского морского технического университета — одного из старейших технических вузов России.'))); ?></p>
    ...
    <div class="row align-items-center g-5">
      <div class="col-lg-6 fade-in">
        <div class="section-header">
          ...
          <h2 class="section-title"><?php echo nl2br(esc_html(museum_opt_raw('about_title', 'Хранители морской истории России'))); ?></h2>
          <div class="section-divider"></div>
        </div>
        <p><?php echo nl2br(esc_html(museum_opt_raw('about_text1', 'Музей СПбГМТУ — один из крупнейших технических музеев Санкт-Петербурга. Основанный более 80 лет назад, он бережно хранит историю отечественного кораблестроения, судьбы выпускников и традиции главного морского вуза страны.'))); ?></p>
        <p><?php echo nl2br(esc_html(museum_opt_raw('about_text2', 'В фондах музея — модели кораблей, навигационные приборы, архивные документы, личные вещи выдающихся учёных и конструкторов, уникальные фотографии и артефакты, связанные с историей российского флота.'))); ?></p>
